...
function Grid(props) {
  ...
  var colClasses =
    ((_colClasses = {}),
    _defineProperty(_colClasses, classes.noGutter, noGutter),
    _defineProperty(_colClasses, classes["s" + s], s),
    _defineProperty(_colClasses, classes["m" + m], m),
    _defineProperty(_colClasses, classes["l" + l], l),
    _defineProperty(_colClasses, classes["xl" + xl], xl),
    _colClasses);
